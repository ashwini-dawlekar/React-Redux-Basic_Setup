...
class Book extends React.Component {
    ...
    componentWillMount(){
        ...
        data = this.props.getAllBooksList.data;
    }
                            ...
                            <div className="col-xs-12">
                                <div className="box">
                                    <div className="box-header">
                                        ...
                                        <a href="#/add" className="btn btn-success pull-right">Add new</a>
                                    </div>
                                    <div className="box-body table-responsive no-padding">
                                        ...
                                        <table className="table table-hover">
                                            ...
                                            {this.props.getAllBooksList.data.map((data1, key) => {
                                                return (
                                                    <tr>
                                                        <td>{data1.bookname}</td>
                                                        <td>{data1.bookauthor}</td>
                                                        <td>{data1.bookpage}</td>
                                                        <td className="pull-right"><div className="btn-group">
                                                            <a href="" className="btn btn-default"><i className="fa fa-pencil"></i></a>
                                                            <a href="#/details" className="btn btn-default"><i className="fa fa-eye"></i></a>
